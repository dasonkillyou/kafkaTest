...
public class AdminSample {
    ...
    public final static String TOPIC_NAME="cwq-topic";
    public final static String TOPIC_NAME2="cwq-topic2";
...
//        ConfigResource configResource = new ConfigResource(ConfigResource.Type.BROKER, TOPIC_NAME);
    ...
    public static void describeTopics() throws Exception {
        AdminClient adminClient = adminClient();
        DescribeTopicsResult describeTopicsResult = adminClient.describeTopics(Arrays.asList(TOPIC_NAME, TOPIC_NAME2));
...
//        ListTopicsResult listTopicsResult = adminClient.listTopics();
    ...
    public static void createTopic() {
        ...
        NewTopic newTopic2 = new NewTopic(TOPIC_NAME2, 3 , rs);
        CreateTopicsResult topics = adminClient.createTopics(Arrays.asList(newTopic, newTopic2));
